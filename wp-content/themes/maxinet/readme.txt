...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About MaxiNet'.
Please install and activate it before starting to use the theme MaxiNet.
...
Theme documentation is available on http://maxinet.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in MaxiNet is Fontello.
