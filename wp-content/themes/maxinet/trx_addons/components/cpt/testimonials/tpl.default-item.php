...
<div class="sc_testimonials_item">
	...
	<div class="sc_testimonials_item_author sc_testimonials_item_author_top">
		<?php if ( has_post_thumbnail() ) { ?>
			<div class="sc_testimonials_item_author_avatar"><?php the_post_thumbnail( apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('square'), 'testimonials-default'), array('alt' => get_the_title()) ); ?></div>
		<?php } ?>
	</div>
