...
?><article 
	...
	if ( !in_array($post_format, array('link', 'aside', 'status', 'quote')) ) {
		...
		<div class="post_header entry-header">
			<div class="post_info"><span class="post_categories"><?php maxinet_show_layout(trx_addons_get_post_categories());?></span></div>
			<?php
	...
	if ($number <= $featured) {
		...
		<div class="recent_news_read_more"><a class="sc_button color_style_dark sc_button_default sc_button_size_normal" href="<?php echo esc_url($post_link); ?>"><?php esc_html_e('Read more', 'maxinet'); ?></a></div>
