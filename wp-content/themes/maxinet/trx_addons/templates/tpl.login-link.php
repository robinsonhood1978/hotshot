	...
	?><ul class="sc_layouts_login_menu sc_layouts_menu_nav"><li class="menu-item"><a href="#trx_addons_login_popup" class="trx_addons_popup_link trx_addons_login_link "><?php
		if (!empty($args['text_login'])) {
			?><span class="sc_layouts_item_details sc_layouts_login_details"><?php
				...
				if (!empty($rows[1])) {
					?><span class="sc_layouts_item_details_line2 sc_layouts_iconed_text_line2"><span><?php esc_html_e('or ', 'maxinet'); ?></span><?php echo esc_html($rows[1]); ?></span><?php
				}
			?></span><?php
		}
	?></a></li></ul><?php
			...
			if (!empty($args['user_menu'])) {
				?><ul><?php
					...
					if (current_user_can('publish_posts')) {
						?><li class="menu-item trx_addons_icon-wpforms"><a href="<?php echo esc_url(home_url('/')); ?>/wp-admin/post-new.php?post_type=post"><span><?php esc_html_e('New post', 'maxinet'); ?></span></a></li><?php
						// Delimiter
						?><li class="menu-item menu-delimiter"></li><?php
					}
					do_action('trx_addons_action_login_menu_settings');
					// Settings
					?><li class="menu-item trx_addons_icon-cog"><a href="<?php echo esc_url(get_edit_user_link()); ?>"><span><?php esc_html_e('My profile', 'maxinet'); ?></span></a></li>
                ...
                <?php
					...
					// Logout
					?><li class="menu-item trx_addons_icon-user-times"><a href="<?php echo esc_url(wp_logout_url(home_url('/'))); ?>"><span><?php esc_html_e('Logout', 'maxinet'); ?></span></a></li><?php
