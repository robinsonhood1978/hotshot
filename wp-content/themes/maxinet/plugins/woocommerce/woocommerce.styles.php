...
if ( !function_exists( 'maxinet_woocommerce_get_css' ) ) {
	add_filter( 'maxinet_filter_get_css', 'maxinet_woocommerce_get_css', 10, 4 );
	function maxinet_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce .shop_mode_thumbs.list_products div.product p.price, .woocommerce .shop_mode_thumbs.list_products div.product span.price,
.woocommerce .shop_mode_thumbs.list_products span.amount, .woocommerce-page .shop_mode_thumbs.list_products span.amount, .single-product ul.products li.product .post_data .price  {
	color: {$colors['inverse_link']};
	background-color: {$colors['extra_link']};
}
...
/* Shop mode selector */
.maxinet_shop_mode_buttons a {
	color: {$colors['text_hover']};
}
.maxinet_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
.shop_mode_thumbs .maxinet_shop_mode_buttons a.woocommerce_thumbs,
...
.scheme_self.woocommerce .quantity input.qty, .scheme_self.woocommerce #content .quantity input.qty, .scheme_self.woocommerce-page .quantity input.qty, .scheme_self.woocommerce-page #content .quantity input.qty {
