...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (MAXINET_STORAGE['button_hover'] && MAXINET_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.maxinet_tabs .maxinet_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+MAXINET_STORAGE['button_hover']);
		if (MAXINET_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.maxinet_tabs .maxinet_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+MAXINET_STORAGE['button_hover']);
