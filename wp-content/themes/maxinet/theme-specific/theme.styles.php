...
if (!function_exists('maxinet_customizer_get_css')) {

	function maxinet_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = maxinet_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('maxinet_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];

			
			// Border radius
			//--------------------------------------
			$rad = maxinet_get_border_radius();
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<CSS
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(maxinet_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = maxinet_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = maxinet_customizer_add_theme_colors($colors);
...
input[placeholder]::-webkit-input-placeholder { color: {$colors['text_light']}; }
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['text_light']}; }
input[placeholder]::-moz-placeholder { color: {$colors['text_light']}; }
textarea[placeholder]::-moz-placeholder				{ color: {$colors['text_light']}; }
input[placeholder]:-ms-input-placeholder { color: {$colors['text_light']}; }
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['text_light']}; }
input[placeholder]::placeholder { color: {$colors['text_light']}; }
textarea[placeholder]::placeholder					{ color: {$colors['text_light']}; }
...
.sc_layouts_row_type_normal .sc_button_bordered:not(.sc_button_bg_image):hover {
	color:{$colors['text_link']};
}


/* Alter button */
.sc_button_alter:not(.sc_button_bg_image) {
	color:{$colors['inverse_link']} !important;
	background-color:{$colors['text_link']} !important;		
}
.sc_button_alter:not(.sc_button_bg_image):hover {
	color:{$colors['text_hover']} !important;
	background-color:{$colors['inverse_link']} !important;
}

/* Extra button */
.sc_button_extra:not(.sc_button_bg_image) {
	color:{$colors['inverse_link']} !important;
	background-color:{$colors['text_link2']} !important;		
}
.sc_button_extra:not(.sc_button_bg_image):hover {
	color:{$colors['text_hover']} !important;
	background-color:{$colors['inverse_link']} !important;
}
...
/* WP Standard classes 
-------------------------------------------- */
.sticky, .sticky.post_layout_classic, .sticky.post_item{
...
.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover,
.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover:after,
.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover:after,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item .social_item:hover .sc_layouts_item_icon {
	color: {$colors['text_hover']};
}
...
.sc_layouts_row_type_narrow a.trx_addons_login_link:hover .sc_layouts_item_details_line1,
.scheme_self.sc_layouts_row_type_narrow a.trx_addons_login_link:hover .sc_layouts_item_details_line1 {
	color: {$colors['text_hover']} !important;
}
...
.sc_layouts_row_type_narrow a.sc_layouts_item_link:hover .sc_layouts_item_details_line2,
.scheme_self.sc_layouts_row_type_narrow a.sc_layouts_item_link:hover .sc_layouts_item_details_line2 {
	color: {$colors['text_hover']};
}


.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 .cart_description,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 .cart_description{
	color: {$colors['text_dark']};
}

.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 .sc_layouts_cart_items:hover,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 .sc_layouts_cart_items:hover{
	color: {$colors['text_hover']} !important;
}
...
.sc_layouts_row_type_normal .sc_layouts_iconed_text_details:hover .sc_layouts_item_details_line1,
.sc_layouts_row_type_normal .sc_layouts_iconed_text_details:hover .sc_layouts_item_details_line2 {
	color: {$colors['text_hover']};
}
...
.sc_layouts_title_breadcrumbs a:first-child {
...
/* Menu */
.sc_layouts_menu_nav > li > a,
.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu_nav > li > a, 
...
.sc_layouts_row_type_compact .sc_layouts_menu_nav > li > a:hover {
	color: {$colors['text_link']} !important; 
}
...
.maxinet_tabs .maxinet_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.maxinet_tabs .maxinet_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_hover']};
}
...
.post_item .post_title a:hover i,
.post_item .post_title a:hover mark,
.post_item .post_title a:hover ins {
	color: {$colors['text_link']};
}
...
.scheme_self .mejs-container, 
.scheme_self .format-audio .post_featured .mejs-container {
	background-color: {$colors['inverse_light']} !important;
}
...
.scheme_self .trx_addons_audio_player .mejs-container:not(.mejs-video) {
	background: {$colors['bg_color_02']} !important;
}
...
/* Single post */
.post_item_single .single_post_content_wrap{
	background-color: {$colors['alter_bg_hover']};
}
...
.comments_list_wrap .comment_text table > tbody > tr > th {
	color: {$colors['extra_dark']};
	background-color: {$colors['extra_bg_color']};
}
...
CSS;
					...
					$rez = apply_filters('maxinet_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'maxinet_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>