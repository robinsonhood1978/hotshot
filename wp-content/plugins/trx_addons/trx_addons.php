...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.6.38.2' );
...
if ( ! function_exists( 'maxinet_trx_addons_privacy_text' ) ) {
    add_filter( 'trx_addons_filter_privacy_text', 'maxinet_trx_addons_privacy_text' );
    function maxinet_trx_addons_privacy_text( $text='' ) {
        return maxinet_get_privacy_text();
    }
}
