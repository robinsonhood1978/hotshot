...
// Else if user logged in
	...
	?><ul class="sc_layouts_login_menu sc_layouts_dropdown sc_layouts_menu_nav">
		<li class="menu-item trx_addons_icon-cog"><a href="/checkout/?add-to-cart=13770&quantity=1"><span><?php esc_html_e('Change credit card', 'trx_addons'); ?></span></a></li>
		<li class="menu-item menu-item-has-children">
			...
			if (!empty($args['user_menu'])) {
				?><ul><?php
					...
					// Settings
					?><li class="menu-item trx_addons_icon-cog"><a href="<?php echo esc_url(get_edit_user_link()); ?>"><span><?php esc_html_e('My profile', 'trx_addons'); ?>
					<li class="menu-item trx_addons_icon-cog"><a href="/checkout/?add-to-cart=13770&quantity=1"><span><?php esc_html_e('Change credit card', 'trx_addons'); ?></span></a></li>
					</span></a></li><?php
					// Delimiter
					?><li class="menu-item menu-delimiter"></li><?php
