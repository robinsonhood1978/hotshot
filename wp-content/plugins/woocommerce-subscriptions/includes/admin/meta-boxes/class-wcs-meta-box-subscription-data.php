	...
	public static function output( $post ) {
		...
		<div class="panel-wrap woocommerce">
			...
			<div id="order_data" class="panel">
                ...
                <?php $subscription_id = $subscription->get_id();  ?>
                <div class="order_data_column_container">
                    <div class="order_data_column">
                        ...
                        <div class="address">
                            <p>
                                ...
                                <?php echo get_post_meta( $subscription_id, '_contact_first_name', true ); ?>
                            </p>
                            <p>
                                <strong>Last name:</strong>
                                <?php echo get_post_meta( $subscription_id, '_contact_last_name', true ); ?>
                            </p>
                            <p>
                                <strong>Contact number:</strong>
                                <?php echo get_post_meta( $subscription_id, '_contact_number', true ); ?>
                            </p>
                            <p>
                                <strong>Contact email:</strong>
                                <?php echo get_post_meta( $subscription_id, '_contact_email', true ); ?>
                            </p>
                            <p>
                                <strong>Installation address:</strong>
                                <?php echo get_post_meta( $subscription_id, '_installation_address', true ); ?>
                            </p>
                            <p>
                                <strong>Is moving house:</strong>
                                <?php echo get_post_meta( $subscription_id, '_is_move_house', true ); ?>
                            </p>
                            <p>
                                <strong>Previous subscription ID:</strong>
                                <?php echo get_post_meta( $subscription_id, '_origin_subscription_id', true ); ?>
                            </p>
                            <p>
                                <strong>Connection date:</strong>
                                <?php echo get_post_meta( $subscription_id, '_connection_date', true ) == 'other' ? get_post_meta( $subscription_id, '_prefer_date', true ) : get_post_meta( $subscription_id, '_connection_date', true ); ?>
                            </p>
                            <p>
                                <strong>Landline status:</strong>
                                <?php echo get_post_meta( $subscription_id, '_has_landline', true ); ?>
                            </p>
                            <p>
                                <strong>Last provider status:</strong>
                                <?php echo get_post_meta( $subscription_id, '_last_provider', true ); ?>
                            </p>
                            <p>
                                <strong>Last provider Account Number:</strong>
                                <?php echo get_post_meta( $subscription_id, '_current_provider_account', true ); ?>
                            </p>
                            <p>
                                <strong>Delivery instructions:</strong>
                                <?php echo get_post_meta( $subscription_id, '_order_comments', true ); ?>
                            </p>
                        </div>
                    </div>
                </div>
