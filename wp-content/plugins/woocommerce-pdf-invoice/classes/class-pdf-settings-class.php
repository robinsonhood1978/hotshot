                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            ...
                            <img class="help_tip woocommerce-help-tip" data-tip="<?php _e('Do you want to create the invoice details when the order is paid for (processing) or wait until you have shipped (completed), from version 1.2.1 you can also create an invoice when the order status is On-Hold', 'woocommerce-pdf-invoice' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                        </th>
                        <td class="forminp forminp-number">
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            ...
                            <img class="help_tip woocommerce-help-tip" data-tip="<?php _e('If you have past orders that have been completed, do you want to create invoices for them?', 'woocommerce-pdf-invoice' ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                        </th>
                        <td class="forminp forminp-number">
